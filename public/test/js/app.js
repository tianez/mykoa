...
/***/ function(module, exports, __webpack_require__) {
	...
	window.Rd = __webpack_require__(72);

	var routers = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pagedata = __webpack_require__(76);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestAdd = _require.TestAdd;
	var TestDetail = _require.TestDetail;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = __webpack_require__(80);
	var Login = __webpack_require__(98);
	var TestAdd = __webpack_require__(101);
	var TestDetail = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = function (_React$Component) {
	    ...
	    _createClass(Home, [{
	        ...
	        key: '_onChangeOption',
	        value: function _onChangeOption(name, value) {
	            var info = this.state.info;
	            // info[name] = value
	            console.log(name);
	        ...
	        value: function render() {
	            var info = this.state.info;
	            var render = React.createElement('section', {
	            ...
	            }.bind(this)), React.createElement(Button, {
	                type: 'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormGroup = __webpack_require__(91);
	var Input = __webpack_require__(92);
	var Textarea = __webpack_require__(93);
	var Radio = __webpack_require__(94);
	var Checkbox = __webpack_require__(95);
	var Button = __webpack_require__(96);
	var Hidden = __webpack_require__(97);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var request = module.exports = __webpack_require__(88).bind(null, Request);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Radio = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        if (this.props.ext) {
	            request.get('admin/' + this.props.ext).end(function (err, res) {
	                var data = JSON.parse(res.text);
	                this.setState({
	                    option: data
	                });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormGroup = function (_React$Component) {
	    ...
	    _createClass(FormGroup, [{
	        ...
	        value: function render() {
	            ...
	            var show2 = _props.show2;

	            var ecls = classNames({
	                weui_cell: true,
	                weui_cell_warn: error
	            });
	            return React.createElement('section', {}, show ? React.createElement('div', {
	            ...
	            }, this.props.children), error ? React.createElement('div', {
	                className: 'weui_cell_ft'
	            }, React.createElement('i', {
	                className: 'weui_icon_warn'
	            })) : null)), help ? React.createElement('div', {
	...
	var Input = function (_React$Component2) {
	    ...
	    _createClass(Input, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return React.createElement(FormGroup, this.props, React.createElement('input', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var testDetail = function (_React$Component) {
	    ...
	    function testDetail(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, (testDetail.__proto__ || Object.getPrototypeOf(testDetail)).call(this, props));
	    ...
	    _createClass(testDetail, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            getfetch('api/tests/add').then(function (res) {
	        ...
	        key: '_onChangeType',
	        value: function _onChangeType(name, value) {
	            var info = this.state.info;
	            info[name] = value;
	            this.setState({
	                info: info
	        ...
	        key: '_addOption',
	        value: function _addOption(e) {
	            var info = this.state.info;
	            var length = info.options.length - 1;
	            var isnew = info.options.every(function (o) {
	                if (o.content == '') {
	        ...
	        key: '_deleteOption',
	        value: function _deleteOption(index) {
	            var info = this.state.info;
	        ...
	        key: '_onAnswer',
	        value: function _onAnswer(name, value) {
	            var info = this.state.info;
	            info[name] = value;
	            this.setState({
	                info: info
	        ...
	        value: function _onSubmit(e) {
	            ...
	            postfetch('api/tests/detail', this.state).then(function (res) {
	                this.props.history.pushState(null, 'api/tests/' + this.state.info.id);
	                Rd.message(res.msg);
	            }.bind(this));
	        }
	    }, {
	...
	var Option = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement('div', {
	            ...
	            className: 'form-ico fa'
	        }, this.props.limit) : null, React.createElement('input', {
	            className: 'form-input',
	            type: this.props.type,
	            max: this.props.max,
	            value: this.state.value,
	...
	var testDetail = function (_React$Component) {
	    ...
	    _createClass(testDetail, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            getfetch('api/tests/detail/' + id).then(function (res) {
	                res.info.answer = JSON.parse(res.info.answer);
	                console.log(res);
	                res.info.type = [0];
	                this.setState({
