...
/***/ function(module, exports) {
	...
	var TestAdd = function (_React$Component) {
	    _inherits(TestAdd, _React$Component);

	    function TestAdd(props) {
	        _classCallCheck(this, TestAdd);

	        var _this = _possibleConstructorReturn(this, (TestAdd.__proto__ || Object.getPrototypeOf(TestAdd)).call(this, props));
